...
import 'game03_screen_model.dart';
export 'game03_screen_model.dart';

class Game03ScreenWidget extends StatefulWidget {
  const Game03ScreenWidget({super.key});

  static String routeName = 'Game_03_Screen';
  static String routePath = '/game03Screen';

  @override
  State<Game03ScreenWidget> createState() => _Game03ScreenWidgetState();
}

class _Game03ScreenWidgetState extends State<Game03ScreenWidget> {
  late Game03ScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Game03ScreenModel());
