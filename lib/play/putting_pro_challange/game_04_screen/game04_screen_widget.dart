...
import 'game04_screen_model.dart';
export 'game04_screen_model.dart';

class Game04ScreenWidget extends StatefulWidget {
  const Game04ScreenWidget({super.key});

  static String routeName = 'Game_04_Screen';
  static String routePath = '/game04Screen';

  @override
  State<Game04ScreenWidget> createState() => _Game04ScreenWidgetState();
}

class _Game04ScreenWidgetState extends State<Game04ScreenWidget> {
  late Game04ScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Game04ScreenModel());
