...
import 'game_a03_screen_model.dart';
export 'game_a03_screen_model.dart';

class GameA03ScreenWidget extends StatefulWidget {
  const GameA03ScreenWidget({super.key});

  static String routeName = 'GameA_03_Screen';
  static String routePath = '/gameA03Screen';

  @override
  State<GameA03ScreenWidget> createState() => _GameA03ScreenWidgetState();
}

class _GameA03ScreenWidgetState extends State<GameA03ScreenWidget> {
  late GameA03ScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GameA03ScreenModel());
