...
class GameA12ScreenWidget extends StatefulWidget {
  ...
  static String routeName = 'GameA_12_Screen';
  static String routePath = '/gameA12Screen';

  @override
  State<GameA12ScreenWidget> createState() => _GameA12ScreenWidgetState();
}

class _GameA12ScreenWidgetState extends State<GameA12ScreenWidget> {
  late GameA12ScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GameA12ScreenModel());
                ...
                children: [
                  Padding(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/Bandeira_logo.png',
                        width: 50.0,
                        fit: BoxFit.fill,
                      ),
                    ),
