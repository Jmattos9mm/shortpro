...
import 'game02_screen_model.dart';
export 'game02_screen_model.dart';

class Game02ScreenWidget extends StatefulWidget {
  const Game02ScreenWidget({super.key});

  static String routeName = 'Game_02_Screen';
  static String routePath = '/game02Screen';

  @override
  State<Game02ScreenWidget> createState() => _Game02ScreenWidgetState();
}

class _Game02ScreenWidgetState extends State<Game02ScreenWidget> {
  late Game02ScreenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Game02ScreenModel());
